...
async def not_joined(client: Client, message: Message):
    text = "<b>🤚🏻 Kamu Harus [Gabung/Join] Channel Update Terlebih Dahulu\nJika Sudah Bergabung Silahkan Pencet 👉🏻</b>"
    message_text = message.text
    try:
        command, argument = message_text.split()
        text = text + f" <b><a href='https://t.me/{client.username}?start={argument}'>Mengambil File Kembali</a></b>"
    except ValueError:
        pass
